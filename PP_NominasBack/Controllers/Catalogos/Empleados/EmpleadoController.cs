...
namespace PP_NominasBack.Controllers.Catalogos.Empleados
{
    ...
    public class EmpleadoController : ControllerBase
    {
        ...
        // POST: api/Empleado
        [HttpPost]
        public async Task<ActionResult> Post([FromBody] EmpleadoDto dto)
        {
            if (dto.Persona == null)
            ...
            if (dto.Asignaciones?.Any() == true)
            {
                ...
                var asignaciones = dto.Asignaciones.Select(_mapper.Map<AsignacionPlazaEmpleado>).ToList();
                await _db.GetCollection<AsignacionPlazaEmpleado>("AsignacionPlazaEmpleado").InsertManyAsync(asignaciones);
        ...
        // PUT: api/Empleado/{id}
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(string id, [FromBody] EmpleadoDto dto)
        {
